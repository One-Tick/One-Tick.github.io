...
•	D2.1 - Machine learning model for assessing the risk of tick bites and following disease occurrence using data on human exposure and tick abundance predictions.
•	D2.2 - Guidelines for tick control strategy.
